...
const TABS = [
  {
    ...
    content: (
      <div className='space-y-4'>
        ...
        <a target='_blank' href='https://drive.google.com/file/d/16DFO30VveMMgkb1e7KUqRAble3J-Gygh/view?usp=sharing' download className='btn flex items-center gap-4'><MoveRight className='h-5 w-5 mt-1'/><TextEffect className="text-2xl">My Resume</TextEffect></a>
      </div>
    ),
  },
  {
